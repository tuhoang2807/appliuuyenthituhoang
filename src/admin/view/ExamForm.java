...
public class ExamForm extends javax.swing.JFrame {
    ...
    public ExamForm() {
        ...
        examTable.getColumnModel().getColumn(6).setCellRenderer(new TableActionCellRender());
        examTable.getColumnModel().getColumn(6).setCellEditor(new TableActionCellEditor());
